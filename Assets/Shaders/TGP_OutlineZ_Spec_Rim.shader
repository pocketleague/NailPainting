...
Shader "Toony Gooch Pro/Outline Z-Correct/MultipleLights/Specular Rim"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyGoochSpec nolightmap nodirlightmap vertex:vert approxview halfasview 
