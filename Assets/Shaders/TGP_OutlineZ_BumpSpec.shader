...
Shader "Toony Gooch Pro/Outline Z-Correct/MultipleLights/Bumped Specular"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyGoochSpec nolightmap nodirlightmap approxview halfasview 
