...
Shader "Toony Gooch Pro/Outline Z-Correct/OneDirLight/Bumped Specular Rim"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyGoochSpec nolightmap nodirlightmap noforwardadd approxview 
