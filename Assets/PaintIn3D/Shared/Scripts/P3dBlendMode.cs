...
namespace PaintIn3D
{
	...
	public struct P3dBlendMode
	{
		...
		public static P3dBlendMode NormalBlend { get { return new P3dBlendMode() { Index = NORMAL_BLEND, Color = Color.white }; } }
		public static P3dBlendMode NormalReplace { get { return new P3dBlendMode() { Index = NORMAL_REPLACE, Color = Color.white }; } }
