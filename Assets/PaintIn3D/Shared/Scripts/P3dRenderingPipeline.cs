...
namespace PaintIn3D
{
	...
	public class P3dRenderingPipeline_Editor : Editor
	{
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.HelpBox("This tool allows you to quickly switch Paint in 3D between using the Standard graphics pipeline, and the scriptable graphics pipeline.", MessageType.Info);

			EditorGUILayout.HelpBox("If you upgrade Paint in 3D, then you may need to click the Switch To ___ Pipeline button again.", MessageType.Info);
