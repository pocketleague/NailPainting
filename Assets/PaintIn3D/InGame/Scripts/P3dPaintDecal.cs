...
namespace PaintIn3D
{
	...
	public class P3dPaintDecal : MonoBehaviour, IHit, IHitPoint, IHitLine, IHitQuad, IHitRaycast
	{
		...
		/// <summary>This allows you to control how quickly the triplanar mapping transition between the X/Y/Z planes.</summary>
...
namespace PaintIn3D
{
	...
	public class P3dPaintDecal_Editor : P3dEditor<P3dPaintDecal>
	{
		...
		protected override void OnInspector()
		{
			...
			Draw("tileTransition", "This allows you to control how quickly the triplanar mapping transition between the X/Y/Z planes.");
