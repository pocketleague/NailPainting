...
namespace PaintIn3D
{
	...
	public class P3dHitScreen : P3dConnectablePoints
	{
		...
		/// None = Basic drawing only.
		/// GridOfPoints = The drawn shape will be filled in with points in a regular grid.</summary>
		public FillType Fill { set { fill = value; } get { return fill; } } [SerializeField] private FillType fill;
...
namespace PaintIn3D
{
	...
	public class P3dHitScreen_Editor : P3dConnectablePoints_Editor<P3dHitScreen>
	{
		protected override void OnInspector()
		{
			...
			Draw("fill", "This allows you to control how the drawn shape is filled.\n\nNone = Basic drawing only.\n\nGridOfPoints = The drawn shape will be filled in with points in a regular grid.");
			if (Any(t => t.Fill != P3dHitScreen.FillType.None))
			{
				BeginIndent();
